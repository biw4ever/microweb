...
public class MultipartFullHttpRequestWrapper extends FullHttpRequestWrapper implements MultipartHttpServletRequest
{
    ...
    public MultipartFullHttpRequestWrapper(ServletContext servletContext, HttpDataFactory factory,
        FullHttpRequest request, String requestURI, Map<String, String[]> parameters)
    {
        ...
        try
        {
            ...
            while (decoder.hasNext())
            {
                ...
                else if (dataType.equals(HttpDataType.FileUpload))
                {
                    ...
                    multipartFiles.add(name, new MicrowebMultipartFile(fileUpload, filename));
                }
