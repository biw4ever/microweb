...
public class MicrowebMultipartFile implements MultipartFile {
	
	private final FileUpload fileUpload;
	private final String filename;
	private Logger logger = LoggerFactory.getLogger(MicrowebMultipartFile.class);
	
	public MicrowebMultipartFile(FileUpload fileUpload, String filename) {
