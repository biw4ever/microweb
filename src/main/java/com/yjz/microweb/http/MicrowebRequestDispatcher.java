...
public class MicrowebRequestDispatcher implements RequestDispatcher {
	
	private final Logger logger = LoggerFactory.getLogger(MicrowebRequestDispatcher.class);

	private final String resource;

	public MicrowebRequestDispatcher(String resource) {
